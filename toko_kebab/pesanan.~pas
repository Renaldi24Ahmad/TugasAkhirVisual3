...
begin
zqry1.sql.clear;
zqry1.sql.Add('insert into pesanan values(null,"'+edit1.Text+'","'+edit2.Text+'","'+edit3.Text+'","'+edit4.Text+'")');
zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update pesanan set nik= "'+Edit1.Text+'",nama="'+Edit2.Text+'", pendidikan= "'+Edit3.Text+'",pekerjaan= "'+Edit4.Text+'"  where id_ortu ="'+id+'"');
zqry1.ExecSQL; 
