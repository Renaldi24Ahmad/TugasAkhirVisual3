...
begin
zqry1.sql.clear;
zqry1.sql.Add('insert into kritik_saran values(null,"'+edt1.Text+'","'+edt2.Text+'")');
zqry1.ExecSQL;

zqry1.SQL.Clear;
zqry1.SQL.Add('select * from kritik_saran');
zqry1.Open;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update kritik_saran set nama_poin= "'+edt1.Text+'",bobot="'+edt2.Text+'" where id_poin ="'+id+'"');
zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from kritik_saran where id_poin ="'+id+'"');
zqry1.ExecSQL;
